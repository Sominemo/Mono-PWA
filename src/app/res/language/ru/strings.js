export default {
    ...
    auth: {
        "": "Авторизация",
        unofficial_warning: "Mono PWA — неофициальное приложение. Оно не разработано monobank. Используйте приложение только если вы доверяете разработчику и понимаете риски (см. Дисклеймер)",
        ...
        stage: {
            ...
            instructions: {
                scan: {
                    "": "Отсканируйте QR код",
                    description: "Откройте monobank › Ещё › Сканер QR-кода",
                },
                follow: {
                    "": "Перейдите по ссылке",
    ...
    settings: {
        ...
        descriptions: {
            ...
            language: "Украинский, русский, английский",
            notifications: "Уведомления о транзакциях, новости",
        ...
        notifications: {
            ...
            empty_info: "авторизуйтесь с помощью поддерживаемого аккаунта monobank, чтобы подписываться на уведомления",
...
вами осведомлённо. 
Приложение собирает некоторые деперсонифицированные данные через сервис Google Analytics. Ваши имя, фамилия, уникальные идентификаторы и другие 
...
Вы всегда в праве обратиться за исходным кодом приложения по адресу support@sominemo.com, 
изменять, публиковать, исполнять код в любой форме, при этом ответственность за содержимое уже будет лежать именно на вас.`,
    },
    experiments: {
        "": "эксперименты",
    ...
    push: {
        ...
        not_supported: "Нужны дополнительные разрешения",
        not_supported_title: "Нужен доступ к отправке уведомлений",
        not_supported_text: "Чтобы получать уведомления на устройстве iOS/iPadOS, убедитесь, что вы используете iOS 16.4/iPadOS 16.4 или более позднюю версию.\n\n Safari позволяет отправлять уведомления только если приложение добавлено на главный экран. Для этого нажмите кнопку \"Поделиться\" в браузере и выберите \"Добавить на главный экран\".\n\n Если вы не используете iOS или используете более старую версию iOS и видите это сообщение, уведомления не поддерживаются на вашем устройстве или в текущем браузере.",
    },
    fatal_error: {
        "": "Возникла ошибка",
