export default {
    ...
    auth: {
        "": "Авторизація",
        unofficial_warning: "Mono PWA — неофіційний застосунок. Він не розроблений monobank. Використовуйте застосунок лише якщо ви довіряєте розробнику та розумієте ризики (див. Дисклеймер)",
        ...
        stage: {
            ...
            instructions: {
                scan: {
                    "": "Зіскануйте QR код",
                    description: "Відкрийте monobank › Ще › Сканер QR-коду",
                },
                follow: {
    ...
    settings: {
        ...
        descriptions: {
            ...
            language: "Українська, російська, англійська",
            notifications: "Нов транзакції, новини",
        ...
        privacy: {
            ...
            send_reports: {
                ...
                info: "Надсилання журналу подій застосунку. Містить у собі події та помилки, статистику використання, версію застосунку, назву і версію браузера та ОС",
            },
            debug_log: {
...
вами свідомо.
Застосунок збирає деякі деперсоніфіковані дані через сервіс Google Analytics. Ваші ім'я, прізвище, унікальні ідентифікатори 
...
Ви завжди в праві звернутися за сирцевим кодом програми за адресою support@sominemo.com,
змінювати, публікувати, виконувати код в будь-якій формі, при цьому відповідальність за вміст вже буде саме на вас.`,
    ...
    push: {
        ...
        not_supported: "Потрібні додаткові дозволи",
        not_supported_title: "Потрібний дозвіл на надсилання сповіщень",
        not_supported_text: "Щоб отримувати сповіщення на пристрої iOS/iPadOS, переконайтеся, що ви використовуєте iOS 16.4/iPadOS 16.4 або новішу версію.\n\n Safari дозволяє надсилати сповіщення лише якщо застосунок додано на головний екран. Для цього натисніть кнопку \"Поділитись\" у браузері та оберіть \"Додати на головний екран\".\n\n Якщо ви не використовуєте iOS або використовуєте старішу версію iOS і бачите це повідомлення, сповіщення не підтримуються на вашому пристрої або в поточному браузері.",
    },
    fatal_error: {
        "": "Сталась помилка",
